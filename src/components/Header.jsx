...
function Header() {
  return (
    <header className="text-white w-full h-[179px] flex flex-row z-[1000] justify-center items-center fixed bg-green-800 border-solid border-b-[22px] border-yellow-950">
      <div className="flex justify-center items-center w-[97.95%] h-[80%]">
        ...
        <div className="absolute flex right-12 items-center space-x-2 text-[20px]">
          <button className="flex rounded-2xl w-[55px] h-[55px] self-center items-center justify-center hover:opacity-75 hover:bg-green-600 hover:p-2">
